...
public class Helado extends Planeta implements tieneAsentamientos {
    ...
    /**
     * Constructor del planeta helado
     */
    public Helado() {
        ...
        cristalesHidrogeno = (int) (0.65 * 4 * Math.PI * Math.pow(radio, 2));
        floresDeSodio = (int) (0.35 * 4 * Math.PI * Math.pow(radio, 2));
        consumoEnergia = (float) (0.15 * Math.abs(temperatura));
